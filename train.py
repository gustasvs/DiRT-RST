...
#     out = output[0].cpu().detach().numpy(); out = torch.softmax(torch.tensor(out), dim=0); outstr = "["
...
#     else:
#         ax = fig.add_subplot(1, 1, 1); num_cycles = 5  # Number of times to loop through the frames
